...
// ChechHash provides a mock function with given fields: password, hash
func (_m *PasswordHasher) ChechHash(password string, hash string) bool {
	ret := _m.Called(password, hash)

	if len(ret) == 0 {
		panic("no return value specified for ChechHash")
	}
